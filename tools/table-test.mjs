...
console.log('\nAlternar entre Tarjetas y Tabla, con persistencia');
{
  ...
  t('99 filas en la tabla', await page.locator('#product-table-body tr[data-slug]').count(), 99);
  await page.reload();
...
console.log('\nSelección y barra de acciones en lote');
{
  ...
  await page.waitForTimeout(100);
  t('seleccionar todo marca las 99', (await page.locator('#bulk-count').textContent()).includes('99 productos'), true);
