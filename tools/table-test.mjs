...
console.log('\nAlternar entre Tarjetas y Tabla, con persistencia');
{
  ...
  t('116 filas en la tabla', await page.locator('#product-table-body tr[data-slug]').count(), 116);
  await page.reload();
...
console.log('\nSelección y barra de acciones en lote');
{
  ...
  await page.waitForTimeout(100);
  t('seleccionar todo marca las 116', (await page.locator('#bulk-count').textContent()).includes('116 productos'), true);
